...
class SLL
{
   ...
   friend void merge_two_into_one( SLL &, SLL & );   //PROBLEM 1.2
   friend node* union_list( SLL ,SLL );     //PROBLEM 1.3
   friend void intersection_list( SLL ,SLL);    //PROBLEM 1.4
